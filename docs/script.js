const translations = {
  ...
  es: {
    ...
    metaDescription:
      "Soporte bilingue en taxes personales, taxes de negocio, bookkeeping, orientacion ITIN y apertura de empresa en Estados Unidos.",
    brandNote: "Aqui estamos para ayudarte con tus taxes y tu negocio",
    navServices: "Servicios",
    navProcess: "Proceso",
    navFaq: "FAQ",
    navContact: "Contacto",
    heroEyebrow: "Ayuda con tus taxes en ingles y espanol",
    ...
    heroHighlightTitle: "Empieza por una conversacion clara.",
    heroHighlightText:
      "Te ayudamos a entender que revisar primero, que documentos hacen falta y cual podria ser el mejor siguiente paso.",
    proof1Title: "Atencion bilingue",
    proof1Text: "Te atendemos en ingles o espanol, como te sientas mas comodo.",
    proof2Title: "Respuesta cercana",
    proof2Text: "El objetivo es ayudarte a entender rapido que toca resolver primero.",
    heroPrimary: "Escribenos por WhatsApp",
    heroSecondary: "Quiero orientacion",
    confidence1: "Atencion cercana",
    ...
    panelMetric1Label: "Primero entendemos tu situacion, tus fechas y lo que mas te urge resolver.",
    panelMetric2Value: "Te hablamos claro",
    panelMetric2Label: "Puedes comunicarte en ingles o espanol y recibir respuestas practicas, sin enredos.",
    panelMetric3Value: "Te guiamos paso a paso",
    panelMetric3Label: "Te ayudamos a entender documentos, fechas y el siguiente paso con mas confianza.",
    ...
    signatureService4: "Bookkeeping",
    servicesEyebrow: "En que te ayudamos",
    ...
    authority1Text: "Te explicamos lo importante de forma simple para que sepas que esta pasando y que sigue.",
    authority2Title: "Atencion cercana",
    ...
    process3Text: "Te acompanamos para que el proceso avance con mas claridad y menos estres.",
    ...
    formServiceLabel: "En que te ayudamos",
    formServicePlaceholder: "Selecciona una opcion",
    formService1: "Apertura de empresa",
    formService2: "Taxes personales",
    formService3: "Taxes de negocio",
    formService4: "Bookkeeping / payroll",
    formMessageLabel: "Cuentanos un poco",
    formMessagePlaceholder: "Cuentanos brevemente que necesitas",
    formButton: "Enviar mensaje",
    formButtonSending: "Enviando...",
    formNote: "Tu mensaje se enviara directamente para que podamos responderte.",
